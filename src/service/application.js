...
export const getPlatformHospitalByGatewayInfoApi = () => applicationget(`/plat/getPlatformHospitalByGatewayInfo`)
 ...
 * 获取所有一级目录
 */
export const getHelpCenterParentMenuApi = () => applicationget(`/helpCenter/web/getHelpCenterParentMenu`);

/** 
 *  8-3 8-4 帮助指引列表和详情
 * 根据一级目录id获取子目录
 */
export const getHelpCenterMenuByParentMenuIdApi = (parentMenuId) => applicationget(`/helpCenter/web/getHelpCenterMenuByParentMenuId?parentMenuId=${parentMenuId}`);

/** 
 *  8-3 8-4 帮助指引列表和详情
 *根据子目录id查帮助信息
 */
export const getHelpCenterInfoByMenuIdApi = (menuId) => applicationget(`/helpCenter/web/getHelpCenterInfoByMenuId?menuId=${menuId}`);

/** 
 *  8-3 8-4 帮助指引列表和详情
 *根据标题和文章内容来搜索帮助信息
 */
export const searchHelpCenterInfoByTitleOrContentApi = (searchInfo) => applicationget(`/helpCenter/web/searchHelpCenterInfoByTitleOrContent?searchInfo=${searchInfo}`)
...
export const getHelpCenterInfoByIdApi = (helpCenterInfoId) => applicationget(`/helpCenter/web/getHelpCenterInfoById?helpCenterInfoId=${helpCenterInfoId}`)
...
export const statisticalDataApi = (platformHospitalId) => applicationget(`/foreign/applicationNum?platformHospitalId=${platformHospitalId}`)
