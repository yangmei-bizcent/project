            ...
            <el-row type="flex" justify="center">
              ...
              <el-col :span="6">
                <div class="flex-align-justify-column wrap-advange">
                  ...
                  <p class="margintop25">
                    <span class="fontsize6 color-04730e bold">7*24h</span>在线客服
                  </p>
                </div>
              </el-col>
              <el-col :span="6">
                ...
                <div class="absolute color-white width100 fontsize0 borderRadius4 displayNone wrap-casedesc" :class="'case'+index">
                  <div class="relative width100">
                    ...
                    <div class="case-tool absolute">
                      <div @click="toMore(item.url)" class="fontsize0 color-white textAlignCenter inlineBlock cursorPointer likebtn-transparent">了解更多</div>
                    </div>
                  </div>
                </div>
...
import { parse } from "path";
  ...
  (function () {
    ...
    hm.src = "https://hm.baidu.com/hm.js?444bfabd173252e556710559cb3a678b";
  ...
  export default {
    ...
    methods: {
       openDepartDoctorConfig() {
        window.open(`${exportAppUrl}/doctorDepart?token=${sessionStorage.getItem('token')}&platformHospitalId=${this.chooseOrgInfo.platformHospitalId}&platformHospitalName=${encodeURI(this.chooseOrgInfo.name)}&phone=${this.phone}&userName=${encodeURI(this.userName)}&currentDate=${this.currentDateInfo.year}&Jurisdiction=${JSON.stringify(this.hosInfoDate)}`);
        // window.open(`http://localhost:8080/#/doctorDepart?token=${sessionStorage.getItem('token')}&platformHospitalId=${this.chooseOrgInfo.platformHospitalId}&platformHospitalName=${encodeURI(this.chooseOrgInfo.name)}&phone=${this.phone}&userName=${encodeURI(this.userName)}&currentDate=${this.currentDateInfo.year}&Jurisdiction=${JSON.stringify(this.hosInfoDate)}`);
// 报告单查询配置入口
      },
      goTop(){
      ...
      async getFeatures() { //获取各模块权限 
        await axios.get(apiurl.getuserFeatures, axiosConfig).then((res) => {
          if (res.data) {
...
<style lang="scss">
  ...
  .layout-header-tool .el-dropdown {
    position: relative;
    line-height: 20px;
    font-size: 14px;
    color: #FFFFFF;
  ...
  .layout-header-tool .person-dropdown {
    .el-dropdown-link {
      padding: 16px !important;
    }
  }

  .layout-header-tool .el-dropdown .el-dropdown-link {
    max-width: 130px;
    overflow: hidden;
    ...
    &.theme-green-dropdown {
      background: rgba(53, 181, 63, 0.12);
    }
  }

  .layout-header-tool .el-dropdown .headLogo {
    position: absolute;
    top: 5px;
    left: 16px;
    display: block;
  ...
  .layout-header-tool .el-dropdown .headLogo img {
    position: absolute;
    top: 50%;
    left: 50%;
    width: 100%;
  ...
  .page-index {
    ...
    .photo-userlogined {
      width: 50px;
      height: 50px;
      background: url('../assets/img/index/userphoto-logined.png') center no-repeat;
    ...
    .qrcode-wxlogin {
      ...
      // width: 150px;
      // height: 150px;
      // background: url('../assets/img/index/qrcode-wxlogin.png') center no-repeat;
      // background-size: contain;
      iframe {
    ...
    .help-wxlogin {
      width: 140px;
      height: 140px;
      background: url('../assets/img/index/helplogin.png') center no-repeat;
      background-size: contain;
    }
      ...
      .el-form {
        ...
        .el-form-item {
          ...
          .accountLogo {
            ...
            line-height: 40px;
            cursor: default;
            background: url('../assets/img/loginAccountIcon.png')no-repeat center;
          ...
          .passwordLogo {
            ...
            line-height: 40px;
            cursor: default;
            background: url(../assets/img/loginPassIcon.png)no-repeat center;
    ...
    .commonapp {
      background: url('../assets/img/index/index-commonapp.png') center no-repeat;
      background-size: contain;
    }

    .wxservice {
      background: url('../assets/img/index/index-wxservice.png') center no-repeat;
      background-size: contain;
    }

    .wxsmall {
      background: url('../assets/img/index/index-wxsmall.png') center no-repeat;
      background-size: contain;
    }

    .zhifubao {
      background: url('../assets/img/index/index-zhifubao.png') center no-repeat;
      background-size: contain;
    }
    ...
    .safeprotect {
      background: url('../assets/img/index/safeprotect.png') center no-repeat;
      background-size: contain;
    }

    .manyproduct {
      background: url('../assets/img/index/manyproduct.png') center no-repeat;
      background-size: contain;
    }

    .visualconfig {
      background: url('../assets/img/index/visualconfig.png') center no-repeat;
      background-size: contain;
    }

    .appliInteg {
      background: url('../assets/img/index/appliInteg.png') center no-repeat;
      background-size: contain;
    }

    .autodeployment {
      background: url('../assets/img/index/autodeployment.png') center no-repeat;
      background-size: contain;
    }

    .profmedical {
      background: url('../assets/img/index/profmedical.png') center no-repeat;
      background-size: contain;
    }

    .platformarchit {
      background: url('../assets/img/index/platformarchit.png') center no-repeat;
      background-size: contain;
    }

    .goodcustomerserv {
      background: url('../assets/img/index/goodcustomerserv.png') center no-repeat;
      background-size: contain;
    }

    .experience-left-bg {
      height: 460px;
      background: linear-gradient(to right, #ecfef4, #8cd9a8);
      /* 标准的语法 */
      top: 0;
      left: 0;
      z-index: 100;
    ...
    .phone-bg {
      width: 438px;
      height: 748px;
      background: url('../assets/img/index/index-phone.png') center no-repeat;
      background-size: contain;
      top: 0;
      right: 10%;
      z-index: 120;
    ...
    .light-green-bg {
      ...
      top: 230px;
      right: 0;
      background: linear-gradient(to right, #f7fef9, #fcfffe);
    }
    ...
    .icon-pop-arrow {
      ...
      left: 38px;
      top: 92px;
      background: url('../assets/img/index/index-pop-arrow.png') center no-repeat;
      background-size: contain;
    }
    ...
    .title-steps-list {
      .el-tag {
        ...
        &.disabledTag {
          background-color: $color-dfdfdf;
          border-color: $color-dfdfdf;
        }
      }
    }
    ...
    .wrap-casedesc {
      ...
      background-color: $color-00b240-opacity94;
    ...
    .index-circle-bg {
      border-radius: 100%;
      background: linear-gradient(to top right, rgba(255, 255, 255, 0.2), rgba(103, 230, 113, 0.2));
    }
