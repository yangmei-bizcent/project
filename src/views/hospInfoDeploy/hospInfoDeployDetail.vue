...
<script>
  ...
  export default {
    ...
    async created() {
      ...
      this.Jurisdiction();
      if (this.hospId) {
          let res = await axiosget(`/application/branch/admin/getHospitalBranchById?branchId=${this.hospId}`)
      ...
      axiosget(`/application/branch/admin/getProjectCategory`).then(res => {
