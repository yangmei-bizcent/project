<template>
  <el-container class="page-container page-layout layout_minWidth">
    ...
    <el-container class="margintop70" :class={productMarginTop:productMarginTop,margintop70:!margintop70}>
          ...
          <el-menu active-text-color="#04730E" :router="true" :default-active="$route.fullPath" :default-openeds="activeArr"
            ...
            <el-submenu index="2" v-show="boxBaseShow">
              ...
              <el-menu-item-group style="background:#F6F8F9;" ref="baseConfig">
                <el-menu-item index="/publicServiceNum/customizedMenu" v-if="zdycdShow">自定义菜单配置</el-menu-item>
                ...
                <!-- <el-menu-item index="/publicServiceNum/uerAllocation">用户就诊人配置</el-menu-item> -->
      ...
      <el-main class="index-main" :class="{'special-main':$route.name==='appDetail'||'authenStepTwo'?true:false}">
...
// 报告单查询配置入口
      ...
      leftPathRouter(to) { //是否显示左边菜单
        ...
        let arrPath = ['serviceNumIndex', 'messageManage', 'autoReply',
          ...
          'messageRecord','paymentAccountList'
        ];
...
<style lang="scss">
  ...
  .home_title {
    background: url('../assets/img/index/home_tab_icon.png') no-repeat;
  ...
  .application_icon {
    background: url('../assets/img/index/lfetapplication_icon.png') no-repeat;
    background-size: 100% 100%;
  }
