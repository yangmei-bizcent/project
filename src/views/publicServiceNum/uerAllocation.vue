    ...
    methods: {
        ...
        initConfigDatas(d) {
            ...
            let configDatas = d.data.filter((item) => {
                return item.displayType=='0' || item.displayType=='110' || item.displayType=='2' || item.displayType=='6' || item.displayType=='60'
            });
    ...
    .page-useralloc {
        ...
        .topNotice {
            ...
            i {
                position: relative;
                top: 2px;
                background: url('../../assets/img/publicServiceNum/patientvisit-notice.png') center no-repeat;
        ...
        .wrap-custommenu-left {
            width: 346px;
            height: 640px;
            background: url('../../assets/img/publicServiceNum/patientvisit-phonebg.png') center no-repeat;
            background-size: contain;
            overflow: hidden;
            // START-------下拉选择列表
            .mint-actionsheet {
